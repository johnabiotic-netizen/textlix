  ...
  return (
    <PublicLayout>
      <Helmet>
        ...
        <meta name="description" content="Simple credit-based pricing. Buy credits from $2 and use them to get virtual phone numbers from 150+ countries. Credits never expire. No subscriptions." />
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-[#0A1831] to-brand-600 text-white py-20 px-4 text-center">
